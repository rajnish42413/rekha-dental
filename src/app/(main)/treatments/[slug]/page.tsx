...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${service.hero.title} | Rekha Dental`;
  ...
  return {
    ...
    title,
    description,
    keywords: [service.hero.title, "dental treatment", "dentist in Ghaziabad", "Rekha Dental"],
    ...
    openGraph: {
      ...
      type: "website",
      locale: "en_US",
      images: [{ url: `${FRONTEND_URL}${service.hero.image}`, width: 1200, height: 630, alt: service.hero.title }],
    },
    twitter: {
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    ...
    <Banner
      ...
      overlayColor=""
    />
    <ServiceOverview overview={service.overview} technology={service.technology} />

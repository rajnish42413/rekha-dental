...
const contactCards = [
  ...
  },
  {
    ...
    title: "Visit Us",
    href: "https://maps.app.goo.gl/EFeHWFbazpAbG5EC9",
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
        {contactCards.map((item) => (
          <a
            ...
            className="group flex gap-5 border border-[#E8E1D7] bg-white p-6 transition duration-300 hover:-translate-y-1 hover:border-[#D7C2A0] hover:shadow-lg"
          >
            <div className="flex lg:h-12 lg:w-12 h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#F5EFE4] text-[22px] text-[#0F3B2E] transition group-hover:bg-[#EFE6D7]">
              {item.icon}
            </div>
